...
public:	
	...
	inline void SetMoveDistance(float Distance) { MoveDistance = Distance; }
	...
	inline void SetStartLocation(FVector Location) { StartLocation = Location; SetActorLocation(StartLocation); }
