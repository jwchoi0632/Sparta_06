...
void AMovePlatform::SetMoveDistance(float Distance)
{
	MoveDistance = Distance;
	TargetLocation = StartLocation + CurrentDirection * MoveDistance;
}
...
void AMovePlatform::SetRotateDirection(EDirectionType Direction)
{
	...
	case EDirectionType::XY: CurrentRotate = FRotator(1, 0, 0); break;//FRotator(1, 1, 0); break;
	case EDirectionType::XZ: CurrentRotate = FRotator(0, 1, 0); break;//FRotator(1, 0, 1); break;
	case EDirectionType::YZ: CurrentRotate = FRotator(0, 0, 1); break;//FRotator(0, 1, 1); break;
